...
if 'ServerPrx' not in _M_SpotifyDuPauvre.__dict__:
    ...
    class ServerPrx(Ice.ObjectPrx):
        ...
        def deleteMusic(self, titleMusic, context=None):
            return _M_SpotifyDuPauvre.Server._op_deleteMusic.invoke(self, ((titleMusic, ), context))

        def deleteMusicAsync(self, titleMusic, context=None):
            return _M_SpotifyDuPauvre.Server._op_deleteMusic.invokeAsync(self, ((titleMusic, ), context))

        def begin_deleteMusic(self, titleMusic, _response=None, _ex=None, _sent=None, context=None):
            return _M_SpotifyDuPauvre.Server._op_deleteMusic.begin(self, ((titleMusic, ), _response, _ex, _sent, context))

        def end_deleteMusic(self, _r):
            return _M_SpotifyDuPauvre.Server._op_deleteMusic.end(self, _r)
    ...
    Server._op_stopMusic = IcePy.Operation('stopMusic', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
